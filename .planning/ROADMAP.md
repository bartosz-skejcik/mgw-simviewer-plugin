...
- [x] 02-01-PLAN.md — Config + domyślny filtr pustych SIM-ów: flip enable_export, opcja show_unassigned, migracja, bump 1.2.0 (wave 1)
- [x] 02-02-PLAN.md — Natywny eksport CSV: front/export.php (403 gate) + csv_url na datatable (wave 2)
...
| 2. Eksport CSV i filtr pustych SIM-ów | 2/3 | In Progress|  |
